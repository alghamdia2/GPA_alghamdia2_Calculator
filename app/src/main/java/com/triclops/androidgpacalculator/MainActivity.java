...
public class MainActivity extends FragmentActivity {
	...
	String sol=text.getText().toString();String sol1=text1.getText().toString();
	String sol2=text2.getText().toString();String sol3=text3.getText().toString();
	String sol4=text4.getText().toString();
		int index = -1;int index1 = -1;int index2 = -1;int index3 = -1;int index4 = -1;
		...
		if(class1!=-1&&class2!=-1&&class3!=-1&&class4!=-1&&class5!=-1) {
			...
			if(class1==-1){text.setTextColor(Color.RED);}
			if(class2==-1){text1.setTextColor(Color.RED);}
			if(class3==-1){text2.setTextColor(Color.RED);}
			if(class4==-1){text3.setTextColor(Color.RED);}
			if(class5==-1){text4.setTextColor(Color.RED);}
